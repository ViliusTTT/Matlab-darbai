% II uþduotis. Parametrinis interpoliavimas.
% Naudodami nurodytà interpoliavimo metodà parinkti interpoliavimo taðkus taip,
% kad interpoliuojanèios kreivës suformuotø Jûsø vardo ir pavardës pirmàsias raides.
function ParametrinisInterpoliavimas
clc,close all

 s1 ='Vardas';
%s1='Pavarde';
KaPiesti='Vardas';
tf = strcmp(s1,KaPiesti)
hL=[];
if(tf ==1)
    X=[-5 -3 -3 -3 -2 -1 -0  1  2 3  4 4 6 ]        %Vardo sudarymo abscises
    Y=[ 3 5 4  3 2  1 0 1 2 3 4 3 3 ]                  %Vardo sudarymo ordinates
else
    X=[-4 -2 0 4 0 -0.5 -1 -2] %pavardes sudarymo abscises
    Y=[ 6.5 8  7   7 7 4  2 2.5] %pavardes sudarymo ordinates
end
